...
public class MoveWords{
    ...
    private static final String[] validMoves = {"TIJERAS", "PAPEL", "PIEDRA", "LIZARD", "SPOCK"};
    ...
    public static int checkWinner(String first, String second){
		...
		if (( (first_i +1) % validMoves.length ) == second_i ) {
			return GANA;
		} else if (( (first_i +3) % validMoves.length ) == second_i ) {
		 	return GANA;
		} else return PIERDE;
	}
